...
export fn libsce_self_load(libsce: *LibSce, cf_data_ptr: [*]u8, cf_data_len: usize, out_ptr: **Self) abi.ErrorType {
    const self = loadSelf(libsce, libsce.thread_safe_allocator.allocator(), cf_data_ptr[0..cf_data_len], .none) catch |err| {
...
fn loadSelf(libsce: *LibSce, allocator: std.mem.Allocator, cf_data: []u8, license_data: sce.certified_file.LicenseData) !*Self {
